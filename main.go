...
import (
	"github.com/nikitavoloboev/knowledge-map-search-engine/daemon"
)
...
func processFlags() *daemon.Config {
	...
	flag.StringVar(&cfg.Db.ConnectString, "db-connect", "host=/var/run/postgresql dbname=search sslmode=disable", "DB Connect String")
