# LearnAnything OpenAPI Specification
[![Build Status](https://travis-ci.org/learn-anything/learn-anything.svg?branch=master)](https://travis-ci.org/learn-anything/learn-anything)
...
6. If you did everything correct, https://learn-anything.github.io/learn-anything/ will lead to your new docs
...
- Documentation(ReDoc): https://learn-anything.github.io/learn-anything/
- SwaggerUI: https://learn-anything.github.io/learn-anything/swagger-ui/
- Look full spec:
    + JSON https://learn-anything.github.io/learn-anything/swagger.json
    + YAML https://learn-anything.github.io/learn-anything/swagger.yaml
- Preview spec version for branch `[branch]`: https://learn-anything.github.io/learn-anything/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://learn-anything.github.io/learn-anything/ with url from the message: `Server started <url>`
